...
function getGists() {
    ...
    document.getElementById('left').innerHTML =
        "<h3>Search Results</h3><p id='status'></p>";
    ...
    for (var i = 1; i <= pages; i++) {
        ...
        req.onreadystatechange = function() {
            ...
            if (this.readyState === 4) {
                ...
                document.getElementById('status').textContent = 'Total number' +
                ' of results: ' + total;
            }
        };
...
window.onload = function() {
    ...
    document.getElementById('savedTotal').textContent = 'Total number of ' +
    'saved gists: ' + savedTotal;
    document.getElementById('status').textContent = 'Total number of results:' +
    ' ' + total;
};
